...
const AuditActions = {
  ...
  ACTUALIZAR_SEGUIMIENTO_VENTA: 'ACTUALIZAR_SEGUIMIENTO_VENTA',

  CREAR_LICITACION:           'CREAR_LICITACION',
  EDITAR_LICITACION:          'EDITAR_LICITACION',
  CAMBIAR_ESTADO_LICITACION:  'CAMBIAR_ESTADO_LICITACION',
  SUBIR_DOCUMENTO_LICITACION:    'SUBIR_DOCUMENTO_LICITACION',
  ELIMINAR_DOCUMENTO_LICITACION: 'ELIMINAR_DOCUMENTO_LICITACION',
  AGREGAR_GASTO_LICITACION:      'AGREGAR_GASTO_LICITACION',
  ELIMINAR_GASTO_LICITACION:     'ELIMINAR_GASTO_LICITACION',
  DESCARGAR_PDF_LICITACION:      'DESCARGAR_PDF_LICITACION',
};
