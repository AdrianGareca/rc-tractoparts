...
// que habia se quedo en el id 4 y no conocia a Proyectos, asi que la bitacora
// mostraba un 5 pelado justo en el registro de quien cambio un permiso.
...
function formatDetalleValue(key, value) {
  ...
  // Antes salia de un objeto local que llegaba hasta el 4: un cambio de permiso
  // hacia Proyectos se registraba y se mostraba como un 5 sin explicacion.
